...
ResultSet rs = null;
		...
		try{
			...
			String insert_value_single = "select id from Train ";
		...
		<form action = "manager_vehicle_update_ok.jsp" method ="get">
		<table border="1" bordercolor="blue" width ="500" height="300" align = "center" >
    <tr bgcolor="blue" align ="center">
	<p><td colspan = "3" span style="color:white">Vehicle 입력</td></p>
    </tr>
