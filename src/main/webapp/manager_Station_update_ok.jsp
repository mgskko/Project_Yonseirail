...
<%
	...
	ResultSet rs = null;
		...
		try{
			...
			String sql = "UPDATE station  SET  Name = '"
			+ Name + "', Address= '"+ Address + "', Tel= '"+ Tel +"', ManagerName= '"+ ManagerName + "', Budget= "
			+ Budget + ", Headquarter_ID= " + Headquarter_ID + " WHERE ID = "
			+ ID + ""; 
	...
	<form action = "manager_Station_update.jsp" method ="get">
